  ...
  return profileData &&(
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        {
          isEdit
          ?<button onClick={updateProfile} className='px-4 py-1 border border-primary text-sm rounded-full mt- hover:bg-primary hover:text-white transition-all'>Save</button>
          :
          <button onClick={()=>setIsEdit(true)} className='px-4 py-1 border border-primary text-sm rounded-full mt- hover:bg-primary hover:text-white transition-all'>Edit</button>
        }
